package com.simple.happilyeverafter.ui.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.home_bottom_bar_unselect));
        addView(mIcon);
    }
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.home_bottom_bar_select));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.home_bottom_bar_unselect));
        }
    }
